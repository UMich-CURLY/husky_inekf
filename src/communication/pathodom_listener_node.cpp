...
std::string file_name_tum = "/home/tingjun/Desktop/Husky/catkin_ws/src/husky_inekf/data/odom_pose_tum.txt";
...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "path_odom_listener");

  ros::NodeHandle n;

  std::ofstream tum_outfile(file_name_tum);
  tum_outfile.close();
  std::cout << "Ready to subscribe to path_odom topic" << std::endl;
  ros::Subscriber sub = n.subscribe("/odometry/filtered/output", 1000, cameraOdomCallback);
